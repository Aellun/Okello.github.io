    ...
    return (
        <div className="container-content">
            ...
            <div>
                ...
                <h4>IT Support-Digitization --- <a href='https://disigroup.com/about-us/' style={{ color: '#81D8D0', textDecoration: 'underline' }}>Digital Imaging and Scanning International</a></h4>
            ...
            <div>
                <h4>Assistant Project Team Leader --- <a href='https://disigroup.com/about-us/' style={{ color: '#81D8D0', textDecoration: 'underline' }}>Digital Imaging and Scanning International</a></h4>
            ...
            <div>
                <h4>Digitization Supervisor --- <a href='https://disigroup.com/about-us/' style={{ color: '#81D8D0', textDecoration: 'underline' }}>Digital Imaging and Scanning International</a></h4>
            ...
            <div>
                <h4>Attachee-IT Technician --- <a href='https://kenya.ilu.edu/' style={{ color: '#81D8D0', textDecoration: 'underline' }}>International Leadership University</a></h4>
            ...
            <div>
                <h2>Education</h2>
                <h4>Full Stack Software Engineering --- <a href="https://www.alxafrica.com/news/ali-acquires-holberton-school/" style={{ color: '#81D8D0', textDecoration: 'underline' }}> Holberton School and ALX Africa</a></h4>
            ...
            <div>
                <h4>Bachelor of Technology(BIT) --- <a href='https://www.tukenya.ac.ke/sites/default/files/downloads/TUK-list-of-gruaduands-2018.pdf' style={{ color: '#81D8D0', textDecoration: 'underline' }}>The Technical University of Kenya </a></h4>
                <h4>Period --- August 2014-December 2018</h4>
                <h4>Second Class Lower Division</h4>
                <h4>Covered:</h4>
                ...
                <div>
                    ...
                    <h4>Electronic Document Management (ECM) --- <a href="https://hk.newgensoft.com/partners/#resellers" style={{ color: '#81D8D0', textDecoration: 'underline' }}> NewgenSoft</a></h4>
                    <p>Period --- November 2022</p><br />

                    <h4>Leadership and Management (ECM) --- <a href="https://noblework.org/" style={{ color: '#81D8D0', textDecoration: 'underline' }}> Noblework Foundation</a></h4>
                    <p>Period --- July 2021</p><br />

                    <h4> Fundamental of Digital Marketing--- <a href="https://skillshop.exceedlms.com/student/collection/648385-digital-marketing?locale=en" style={{ color: '#81D8D0', textDecoration: 'underline' }}> Google Digital Skills</a></h4>
                    <p>Period --- July 2021</p><br />

                    <h4> Certificate In Information Technology--- <a href="https://www.google.com/search?sca_esv=589766361&sxsrf=AM9HkKn0uTHQS4wbzQM7CT1ZHNrQ66tBfA:1702297227629&q=Cathedral+Church+Of+Christ+The+King&ludocid=1352565100568654148&lsig=AB86z5XAf6Dv27egK50bp54u2Y90&sa=X&ved=2ahUKEwia87esr4eDAxXBe6QEHXZvCWIQ8G0oAHoECEwQAQ&biw=1850&bih=944&dpr=1" style={{ color: '#81D8D0', textDecoration: 'underline' }}> Christ The King Training Institute Nakuru</a></h4>
                    <p>Period --- July 2021</p><br />
                </div>
            </div>
