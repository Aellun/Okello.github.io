...
const Projects = () => {
    return (
        <div className="container-content">
            <h1>PROJECTS</h1>
            <div>
                <h3><a href="https://github.com/Aellun/Solid-Adventures/tree/main/task-manager_GUI" style={{ color: '#81D8D0', textDecoration: 'underline' }}>Task Manager</a></h3>
                <p>Description:<br />
            ...
            <div>
                <h3><a href="https://github.com/Aellun/Solid-Adventures/tree/main/Password_generator" style={{ color: '#81D8D0', textDecoration: 'underline' }}>Password Genrator</a></h3>
                <p>Description:<br />
            ...
            <div>
                <h3><a href="https://github.com/Aellun/Solid-Adventures/tree/main/mycommand-console" style={{ color: '#81D8D0', textDecoration: 'underline' }}>Console</a></h3>
                <p>Description:<br />
            ...
            <div>
                <h3><a href="https://github.com/Aellun/Solid-Adventures/tree/main/calculator" style={{ color: '#81D8D0', textDecoration: 'underline' }}>Calculator</a></h3>
                <p>Description:<br />
            ...
            <div>
                <h3><a href="https://github.com/Aellun/Solid-Adventures/tree/main/my-portfolio" style={{ color: '#81D8D0', textDecoration: 'underline' }}>Portfolio</a></h3>
                <p>Description:<br />
                    Built with Javascript,React,css<br />
                    Simple web- based application that display my skills</p>
            </div>
            <h3><a href='https://github.com/Aellun/Solid-Adventures/tree/main/app_logging' style={{ color: '#81D8D0', textDecoration: 'underline' }}>Logs</a></h3>
            <p>Description:<br />
